...
import { PollComponent } from './components/right-side-bar/poll/poll.component';
...
import { RightSideBarComponent } from './components/right-side-bar/right-side-bar.component'; // optional, provides moment-style pipes for date formatting
